...
FORWARD_TIME_SHORT = 0.7    # Short forward movement
...
CENTERING_1_TURN_DURATION = 0.7  # Duration for horizontal centering turns
CENTERING_1_DRIVE_DURATION = 0.7  # Duration for forward/backward centering adjustments
CENTERING_1_SPEED = 0.45  # Speed for initial centering movements
...
CENTERING_2_TURN_DURATION = 0.7  # Duration for horizontal centering turns (same)
CENTERING_2_DRIVE_DURATION = 0.7  # Duration for forward/backward centering adjustments (same)
CENTERING_2_SPEED = 0.45  # Speed for centering movements (same)
CENTERING_2_Y_TARGET_OFFSET = 100  # Pixels below frame center to target upper green zone

# Final Collection Settings
CENTERING_2_COLLECTION_SPEED = 0.45  # Speed during final collection sequence

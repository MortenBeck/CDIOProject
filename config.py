...
SERVO_SS_STORE = 130        # Store position
SERVO_SS_PRE_COLLECT = 70   # Pre-collect position
SERVO_SS_DRIVING = 40      # Driving position (default/start position)
SERVO_SS_COLLECT = 30      # Collect position
...
FIXED_COLLECTION_DRIVE_TIME = 1  # Fixed time to drive from target zone to collection point
